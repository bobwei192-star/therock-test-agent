...
| 入口类型 | `dedicated_python` |
| 入口脚本 | `test_sanity.py` |
| TEST_COMPONENT | `` |
| Env profiles | `base` |
| Known issue 分类 | `` |
| Official exclude | `` |
| Wrapper | `/home/zs/TheRock/runs/20260710_153107_1747ce36/wrappers/sanity-quick.round4.sh` |
| 测试脚本 | `/home/zs/TheRock/runs/20260710_153107_1747ce36/wrappers/sanity-quick.round4.sh` |
| 原始测试命令 | `python3 /home/zs/TheRock/build_tools/github_actions/test_executable_scripts/test_sanity.py` |
| 测试命令 | `/home/zs/TheRock/runs/20260710_153107_1747ce36/wrappers/sanity-quick.round4.sh` |
| 单用例复现命令 | 暂未缩小到单用例 |
...
| 返回码 / 信号 | `1` |
| 执行耗时 | `0.79s` |
| 日志路径 | stdout: `/home/zs/TheRock/runs/20260710_153107_1747ce36/logs/sanity-quick.round4.stdout.log`<br>stderr: `/home/zs/TheRock/runs/20260710_153107_1747ce36/logs/sanity-quick.round4.stderr.log` |
| Wrapper 环境变更 | `AMDGPU_FAMILIES, HIP_PATH, LD_LIBRARY_PATH, OUTPUT_ARTIFACTS_DIR, PATH, ROCM_PATH, SHARD_INDEX, TEST_TYPE, THEROCK_AMDGPU_FAMILIES, THEROCK_AMDGPU_TARGETS, THEROCK_BIN_DIR, TOTAL_SHARDS` |
...
| 失败用例名称 | 暂未解析 |
| 原始判断 | 自动分类待补充 |
| 来源位置 | `/home/zs/TheRock/runs/20260710_153107_1747ce36/logs/sanity-quick.round4.stderr.log` |
| 是否历史失败 | 不确定 |
| 是否本次新增失败 | 不确定 |
| 是否影响 CI 阻塞 | 是 |
...
| 关键环境变量 | `ROCM_PATH=/home/zs/TheRock/output-linux-portable/build/dist/rocm`, `OUTPUT_ARTIFACTS_DIR=/home/zs/TheRock/output-linux-portable/build/dist/rocm` |
| 权限 | sudo_policy=`askpass` |
| 是否单 GPU | 不确定 |
...
| 构建目标架构 | `gfx1151` |
| 组件运行索引 | `/home/zs/TheRock/docs_this_project/component_env_script_index.json` |
| 官方排除索引 | `/home/zs/TheRock/docs_this_project/official_exclude.json` |

## 复现 / 复测步骤

1. 进入 TheRock 仓库目录。
2. 确认 artifacts 路径：`/home/zs/TheRock/output-linux-portable/build`。
3. 执行命令：`/home/zs/TheRock/runs/20260710_153107_1747ce36/wrappers/sanity-quick.round4.sh`。
4. 查看 stdout：`/home/zs/TheRock/runs/20260710_153107_1747ce36/logs/sanity-quick.round4.stdout.log`。
5. 查看 stderr：`/home/zs/TheRock/runs/20260710_153107_1747ce36/logs/sanity-quick.round4.stderr.log`。
...
- stdout log：`/home/zs/TheRock/runs/20260710_153107_1747ce36/logs/sanity-quick.round4.stdout.log`
- stderr log：`/home/zs/TheRock/runs/20260710_153107_1747ce36/logs/sanity-quick.round4.stderr.log`
- 失败摘要：Traceback (most recent call last):
...
- `global_state.json`: `/home/zs/TheRock/runs/20260710_153107_1747ce36/global_state.json`
- `summary_report.md`: `/home/zs/TheRock/runs/20260710_153107_1747ce36/summary_report.md`
- stdout: `/home/zs/TheRock/runs/20260710_153107_1747ce36/logs/sanity-quick.round4.stdout.log`
- stderr: `/home/zs/TheRock/runs/20260710_153107_1747ce36/logs/sanity-quick.round4.stderr.log`
- wrapper: `/home/zs/TheRock/runs/20260710_153107_1747ce36/wrappers/sanity-quick.round4.sh`
- wrapper changes: `/home/zs/TheRock/runs/20260710_153107_1747ce36/wrapper_changes.jsonl`
