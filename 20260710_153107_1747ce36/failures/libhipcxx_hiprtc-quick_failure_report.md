...
| 入口脚本 | `test_libhipcxx_hiprtc.py` |
| TEST_COMPONENT | `` |
| Env profiles | `base, libhipcxx` |
| Known issue 分类 | `` |
| Official exclude | `` |
| Wrapper | `` |
| 测试脚本 | `blocked before execution` |
| 原始测试命令 | `` |
| 测试命令 | `blocked before execution` |
| 单用例复现命令 | 暂未缩小到单用例 |
...
| 返回码 / 信号 | `125` |
| 执行耗时 | `0.023s` |
| 日志路径 | stdout: `/home/zs/TheRock/runs/20260710_153107_1747ce36/logs/libhipcxx_hiprtc-quick.round4.stdout.log`<br>stderr: `/home/zs/TheRock/runs/20260710_153107_1747ce36/logs/libhipcxx_hiprtc-quick.round4.stderr.log` |
| Wrapper 环境变更 | `` |
...
| 项目 | 内容 |
|------|------|
| 原始测试结果 | `blocked`, rc=`125` |
| 失败用例数量 | 暂未解析 |
| 失败用例名称 | 暂未解析 |
| 原始判断 | 自动分类待补充 |
| 来源位置 | `/home/zs/TheRock/runs/20260710_153107_1747ce36/logs/libhipcxx_hiprtc-quick.round4.stderr.log` |
| 是否历史失败 | 不确定 |
| 是否本次新增失败 | 不确定 |
| 是否影响 CI 阻塞 | 是 |
...
3. 执行命令：`blocked before execution`。
4. 查看 stdout：`/home/zs/TheRock/runs/20260710_153107_1747ce36/logs/libhipcxx_hiprtc-quick.round4.stdout.log`。
5. 查看 stderr：`/home/zs/TheRock/runs/20260710_153107_1747ce36/logs/libhipcxx_hiprtc-quick.round4.stderr.log`。
...
- stdout log：`/home/zs/TheRock/runs/20260710_153107_1747ce36/logs/libhipcxx_hiprtc-quick.round4.stdout.log`
- stderr log：`/home/zs/TheRock/runs/20260710_153107_1747ce36/logs/libhipcxx_hiprtc-quick.round4.stderr.log`
- 失败摘要：missing_dependency: lit
...
- stdout: `/home/zs/TheRock/runs/20260710_153107_1747ce36/logs/libhipcxx_hiprtc-quick.round4.stdout.log`
- stderr: `/home/zs/TheRock/runs/20260710_153107_1747ce36/logs/libhipcxx_hiprtc-quick.round4.stderr.log`
- wrapper: ``
