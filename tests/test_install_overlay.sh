...
grep -q "edit: allow" "${TARGET_DIR}/.opencode/agents/therock-loop.md"
grep -Fq '"*": allow' "${TARGET_DIR}/.opencode/agents/therock-loop.md"
grep -q "edit: allow" "${TARGET_DIR}/.opencode/agents/therock-executor.md"
grep -q "OpenCode 生成 round analysis" "${TARGET_DIR}/.opencode/agents/therock-debugger.md"
grep -q "edit: allow" "${TARGET_DIR}/.opencode/agents/therock-debugger.md"
grep -q "落盘硬要求" "${TARGET_DIR}/.opencode/agents/therock-debugger.md"
...
grep -q "edit: allow" "${TARGET_DIR}/.opencode/agents/therock-repairer.md"
grep -Fq '"python3 -m pip install *": allow' "${TARGET_DIR}/.opencode/agents/therock-repairer.md"
grep -q "edit: allow" "${TARGET_DIR}/.opencode/agents/therock-reporter.md"
grep -q "落盘硬要求" "${TARGET_DIR}/.opencode/agents/therock-reporter.md"
...
grep -q "成功判定" "${TARGET_DIR}/.opencode/commands/therock-debug-round.md"
grep -q "agent: therock-reporter" "${TARGET_DIR}/.opencode/commands/therock-report.md"
