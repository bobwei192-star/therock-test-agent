...
> **Issue #1535**
> **状态**: closed
> **创建时间**: 2021-07-27T11:16:56Z
> **更新时间**: 2021-07-29T07:54:34Z
> **关闭时间**: 2021-07-29T07:54:34Z
> **作者**: ninatu
> **标签**: 
...
### 评论 #1 — ROCmSupport (2021-07-27T12:25:54Z)

Thanks @ninatu for reaching us out.
Can you please share the exact steps(step by step) to understand and reproduce the problem better.
Thank you.


---

### 评论 #2 — ninatu (2021-07-28T12:02:30Z)

Thanks for the answer! 

I have installed rocm 4.2 following instructions of the [Installation-Guide](https://rocmdocs.amd.com/en/latest/Installation_Guide/Installation-Guide.html). 
Namely, I have installed libnuma-dev and rocm-dkms  (and additionally I have installed mesa-opencl-icd.)

I have installed PyTorch using 
    
    pip3 install torch torchvision -f https://download.pytorch.org/whl/rocm4.2/torch_stable.html

I am running the usual Resnet training. 
The interesting thing is that I alternate training and validation steps (I do validation after each training epoch) 
and the error always occurs at the first iteration of the validation step
(but it's not reproducible, it can occur after 10 training epochs, 55 epochs, or whatever.). 
And it looks like that it's an "out of memory" error, because if I reduce batch size twice, 
the error does not occur. 

To be honest, it would be hard for me to share the code that reproduces the problem 
because it's difficult to isolate the training procedure from all other code. 

---

### 评论 #3 — ROCmSupport (2021-07-29T07:54:34Z)

Thanks @ninatu for the information.
I got your point that you are not able to share the code.
But we can understand the problem only after reproducing the problem. With the details provided by you, we are not able to troubleshoot the problem as we need key things to reproduce.
Hope you got my point.
Feel free to open new issues, if any, once you come across, with all detailed steps.
Thank you.
