...
> **Issue #1400**
> **状态**: closed
> **创建时间**: 2021-03-05T10:40:09Z
> **更新时间**: 2021-03-08T05:43:56Z
> **关闭时间**: 2021-03-05T11:30:48Z
> **作者**: dagomez137
> **标签**: 
...
### 评论 #1 — ROCmSupport (2021-03-05T11:30:48Z)

Thanks @dagmcr for reaching out.
We do not have Ravens in testing with ROCm and we are not claiming official support with ROCm.
I will make sure that Documentation is updated accordingly so that no confusion will be there.
Thank you.


---

### 评论 #2 — dagomez137 (2021-03-05T18:35:03Z)

Thanks @ROCmSupport for the quick replay. I'm still a bit confused because of what the documentation was describing as 'limited support'  (I understand you will remove/clarify that part of the docs) but also because of this AMD layer content for yocto: [meta-amd](https://git.yoctoproject.org/cgit/cgit.cgi/meta-amd) which has (old) support for ROCm for the V1000 platform (which integrates the Raven Ridge mobile GPU):
...
> from: https://git.yoctoproject.org/cgit/cgit.cgi/meta-amd/tree/meta-amd-bsp/README.md

* ROCm recipes: 
    * https://git.yoctoproject.org/cgit/cgit.cgi/meta-amd/tree/meta-amd-bsp/recipes-rocm/opencl/opencl.bb
    * https://git.yoctoproject.org/cgit/cgit.cgi/meta-amd/tree/meta-amd-bsp/recipes-rocm/hsa/hsa.bb
    * https://git.yoctoproject.org/cgit/cgit.cgi/meta-amd/tree/meta-amd-bsp/recipes-rocm/hsa/libhsakmt.bb
...
### 评论 #3 — ROCmSupport (2021-03-08T05:43:56Z)
