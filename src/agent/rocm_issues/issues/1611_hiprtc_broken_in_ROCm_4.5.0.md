...
> **Issue #1611**
> **状态**: closed
> **创建时间**: 2021-11-04T16:27:58Z
> **更新时间**: 2022-02-04T11:58:11Z
> **关闭时间**: 2021-12-13T20:41:08Z
> **作者**: FreddieWitherden
> **标签**: 
...
### 评论 #1 — ex-rzr (2021-11-05T10:29:22Z)

I guess you have two ways:
1) define `hipThreadIdx_*` as `threadIdx.*` in your code
2) replace `hipThreadIdx_*` with `threadIdx.*` all around your sources (`threadIdx.*` are supported by HIP for quite a long time)

One another thing I needed to do was to replace `HIP_DYNAMIC_SHARED` with `extern __shared__`.

---

### 评论 #2 — ROCmSupport (2021-11-10T11:36:24Z)

Hi @FreddieWitherden 
Thanks for reaching out.
Can you please try the recommendations given by @ex-rzr and update.
Let me know if you need more help. Thank you.

---

### 评论 #3 — FreddieWitherden (2021-11-10T18:05:55Z)

I can confirm this resolves the issue.  Is there a full list of what functions/variables are available implicitly without any include directives?

---

### 评论 #4 — ROCmSupport (2021-12-14T06:28:16Z)

Thanks @FreddieWitherden for the closure.
Feel free to open new issues, if any, for quick resolution. Thank you.

---

### 评论 #5 — ROCmSupport (2022-02-04T11:58:10Z)

The real fix is part of ROCm 5.0 which is going to be released soon.
I have verified with our internal builds and its working.
