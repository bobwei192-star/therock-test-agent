...
> **Issue #547**
> **状态**: closed
> **创建时间**: 2018-09-17T21:24:26Z
> **更新时间**: 2018-09-17T23:23:17Z
> **关闭时间**: 2018-09-17T22:05:13Z
> **作者**: Ujjalbuet
> **标签**: 
...
### 评论 #1 — jlgreathouse (2018-09-17T22:05:13Z)

Hi @Ujjalbuet 

To verify, you have an AMD Radeon RX 480, which is a "Polaris 10" GPU. However, it appears that you are running an AMD Family 15h core (Bulldozer, Piledriver, Kaveri, Carrizo, etc.). As described [in our installation directions](https://github.com/RadeonOpenCompute/ROCm/#supported-gpus), your GPU requires that your CPU support PCIe atomics. However, AMD did not add support for PCIe atomics until Family 17h.

As such, I'm sorry to say that ROCm will not work on your combination of CPU and GPU at this time.
