...
> **Issue #96**
> **状态**: closed
> **创建时间**: 2017-03-12T04:33:46Z
> **更新时间**: 2023-11-03T22:45:34Z
> **关闭时间**: 2017-07-01T21:47:30Z
> **作者**: pdaliu
> **标签**: 
...
### 评论 #1 — gstoner (2017-03-12T04:37:35Z)

Those cards are not supported by ROCm that is pre GFX7 GPU code name Tahti.  For Pro Card you want W9100.   R9 Nano is also great card to work with.

g
On Mar 11, 2017, at 10:33 PM, pdaliu <notifications@github.com<mailto:notifications@github.com>> wrote:
...
Reply to this email directly, view it on GitHub<https://github.com/RadeonOpenCompute/ROCm/issues/96>, or mute the thread<https://github.com/notifications/unsubscribe-auth/AD8DuYQhUAVhcSjp9Ufr9jYXjCCkFY7nks5rk3WsgaJpZM4Maby8>.



---

### 评论 #2 — smitty-codes (2023-11-03T22:43:23Z)

@pdaliu I had the same question but for a Mac Pro 2013 with the D500 GPU. According to the old, [now archived, github repo](https://github.com/ROCm/ROCm.github.io/releases/tag/Archiving) for ROCm, it specifically says Tahaiti is not supported (gfx6):

(from the hardware.md file in the archived/released .zip)
...
* Any GPU from the "Southern Islands" (gfx6) generation of GCN 1.0 GPUs, including the following chips:
  * "Cape Verde"
  * "Pitcairn"
  * "Tahiti"
