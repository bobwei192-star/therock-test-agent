...
> **Issue #1489**
> **状态**: closed
> **创建时间**: 2021-06-04T18:47:30Z
> **更新时间**: 2021-06-07T09:45:07Z
> **关闭时间**: 2021-06-07T09:45:06Z
> **作者**: gggh000
> **标签**: 
...
### 评论 #1 — gggh000 (2021-06-04T19:00:57Z)
...
Can it be included in the readme.md? Otherwise it could be tricky to find this prereq steps. 


---

### 评论 #2 — ROCmSupport (2021-06-07T09:45:06Z)

Thanks @gggh000 for reaching out.
Actually roctracer shows the prerequisites explicitly like below @ https://github.com/ROCm-Developer-Tools/roctracer#to-build-and-run-test

 _- ROCm is required
 
 - **Python modules requirements: CppHeaderParser, argparse**.
  To install:
  sudo pip install CppHeaderParser argparse_
