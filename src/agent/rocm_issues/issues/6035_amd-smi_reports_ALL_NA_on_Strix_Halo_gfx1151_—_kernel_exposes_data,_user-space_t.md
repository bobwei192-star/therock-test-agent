...
> **Issue #6035**
> **状态**: open
> **创建时间**: 2026-03-15T14:27:38Z
> **更新时间**: 2026-03-25T14:48:24Z
> **作者**: bkpaine1
> **标签**: status: triage
...
### 评论 #1 — chejh-amd (2026-03-16T05:57:02Z)

amd-smi/amdsmi currently has no monitoring support for the gfx1151 APU (Strix Halo).
The kernel (amdgpu) exposes all metrics correctly through sysfs/hwmon, but amdsmi does not read them, so amd-smi shows power/clock/util/fan/limits as N/A. rocm-smi only works partially for the same reason.

---

### 评论 #2 — pedapudi (2026-03-17T00:53:31Z)

Thanks a lot, @Michelle-HCJ 

Just for clarity, is the objective that amd-smi and rocm-smi will support gfx1151? sysfs/hwmon reporting being accurate is terrific (and I personally appreciate prioritizing accuracy in hwmon), so this is mostly a clarifying question. FWIW, documentation citing sysfs/hwmon for monitoring Strix Halo would go a long way.

---

### 评论 #3 — kraln (2026-03-20T16:07:26Z)
...
|=====================================+========================================|
| 0000:c3:00.0    AMD Radeon Graphics | N/A        N/A   0                 N/A |
|   0       0     N/A             N/A | N/A        N/A              148/512 MB |
+-------------------------------------+----------------------------------------+
+------------------------------------------------------------------------------+
| Processes:                                                                   |
|  GPU        PID  Process Name          GTT_MEM  VRAM_MEM  MEM_USAGE     CU % |
|==============================================================================|
|    0       6910  python3.12             2.8 GB  898.4 KB     2.9 GB  N/A     |
+------------------------------------------------------------------------------+
```
➕ from me, really jarring experience. IMHO either the device should be unsupported (fail with an error, say 'use rocm-smi', etc.) or show proper values. 

---

### 评论 #4 — darren-amd (2026-03-25T14:48:24Z)

Hi @bkpaine1,

Thanks for reporting this issue! A lack of metrics is definitely something that we understand affects the developer experience and is something we are actively working on addressing. Will keep you updated on any progress.
