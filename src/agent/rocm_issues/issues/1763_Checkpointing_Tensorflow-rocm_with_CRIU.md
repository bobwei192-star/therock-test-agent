...
> **Issue #1763**
> **状态**: closed
> **创建时间**: 2022-07-01T22:36:11Z
> **更新时间**: 2022-07-08T22:51:24Z
> **关闭时间**: 2022-07-08T22:51:23Z
> **作者**: Skydermoby
> **标签**: 
...
### 评论 #1 — Skydermoby (2022-07-08T22:51:23Z)

Update:
I'm not sure if this is the best solution, but I found a work around.

Something I didn't mention was that rocm-smi showed vram usage at 99% when tensorflow was running. 
Apparently tensorflow likes to allocate as much memory there is, which explains why criu took around 2 minutes to dump and was unable to restore.

For now, I recommend writing:
`
...
At the beginning of your tensorflow program, change the memory_limit value accordingly.

If anyone else knows of a better solution feel free to reply.
