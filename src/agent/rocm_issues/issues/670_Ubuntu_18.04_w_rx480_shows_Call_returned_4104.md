...
> **Issue #670**
> **状态**: closed
> **创建时间**: 2019-01-13T21:11:37Z
> **更新时间**: 2019-01-14T16:35:02Z
> **关闭时间**: 2019-01-14T16:34:53Z
> **作者**: axxic3
> **标签**: 
...
### 评论 #1 — jlgreathouse (2019-01-13T22:48:26Z)
...
### 评论 #2 — axxic3 (2019-01-14T03:44:44Z)
...
### 评论 #3 — jlgreathouse (2019-01-14T16:34:53Z)

Your combination of CPU and GPU [is not supported on ROCm at this time](https://github.com/RadeonOpenCompute/ROCm/blob/roc-2.0.0/README.md#supported-gpus). In particular, your GPU is from our "gfx8" generation (a "Polaris 10" GPU). gfx8 GPUs [requires CPUs that support PCIe 3.0 atomics](https://github.com/RadeonOpenCompute/ROCm/blob/roc-2.0.0/README.md#supported-cpus), which the FX-8320 does not.

[This section of our manual](https://rocm.github.io/hardware.html) contains much more detail about these [CPU](https://rocm.github.io/hardware.html#currently-not-supported) and [GPU](https://rocm.github.io/hardware.html#gfx8-gpus) requirements.
