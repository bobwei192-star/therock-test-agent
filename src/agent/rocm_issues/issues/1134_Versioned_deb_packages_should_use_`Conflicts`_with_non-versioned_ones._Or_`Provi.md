...
> **Issue #1134**
> **状态**: closed
> **创建时间**: 2020-06-06T18:12:48Z
> **更新时间**: 2023-12-23T18:07:08Z
> **关闭时间**: 2023-12-22T13:17:11Z
> **作者**: baryluk
> **标签**: 
...
### 评论 #1 — ROCmSupport (2021-02-15T13:57:02Z)

Thanks @baryluk for reaching us.
Thanks for your clear definition of the problem.
I will work with packaging team and will come up with an update asap.
Thank you.

---

### 评论 #2 — ROCmSupport (2021-03-09T11:55:02Z)

Hi @baryluk, wish to update you on this.

1. We have plans to have only a single set of packages (all versioned), working on this currently. Might take some time to release, Stay tuned for the updates via rocm docs.
2. Our packaging is not just for Debian, supporting this concern would require an alignment of behaviors between rpm and debian.
3. "Provides" would be very difficult to support as side-by-side (multi-version installs) would be broken if all ROCm side-by-side versions are providing the same thing, without strictly defined versions for each and every package.  So, for Debian Breaks or Conflicts are probably the only reasonable approach to test.
4. Any solution would only support ROCm versions going forward.

I will share more updates soon.

---

### 评论 #3 — tasso (2023-12-19T15:58:18Z)

Is this still an issue?  If not, can we please close it?  Thanks!

---

### 评论 #4 — tasso (2023-12-22T13:17:10Z)
...
### 评论 #5 — baryluk (2023-12-23T18:07:07Z)

Thanks no problem. Once I manage to install ROCm (things are broken, as usual), I will recheck.
