...
> **Issue #1750**
> **状态**: closed
> **创建时间**: 2022-06-08T18:32:40Z
> **更新时间**: 2022-06-09T13:46:55Z
> **关闭时间**: 2022-06-09T13:46:55Z
> **作者**: prckent
> **标签**: 
...
### 评论 #1 — prckent (2022-06-09T13:46:55Z)

Found a workaround/temporary solution: uninstalled everything and used the package manager route from [the install docs. ](https://docs.amd.com/bundle/ROCm-Installation-Guide-v5.1.3/page/How_to_Install_ROCm.html) We used the non version specific installation, which successfully created the previously missing rocm_agent_enumerator in the correct location. However device library's for hipcc (really clang) were still missing. Manually installing rocm-device-libs5.1.0 worked, and HIP builds now run successfully => There is likely an issue in the ROCm packaging for RHEL in at least 5.1.x or some silent dependency problem on our system that we worked around.
