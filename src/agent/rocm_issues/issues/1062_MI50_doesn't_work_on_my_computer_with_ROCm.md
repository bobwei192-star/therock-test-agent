# MI50 doesn't work on my computer with ROCm

> **Issue #1062**
> **状态**: closed
> **创建时间**: 2020-03-28T09:20:25Z
> **更新时间**: 2021-04-05T10:15:52Z
> **关闭时间**: 2021-04-05T10:15:52Z
> **作者**: Raumss
> **标签**: 
> **URL**: https://github.com/ROCm/ROCm/issues/1062

## 描述

I've installed ROCm on my computer as the offical guide told. R7 workes well ,but MI50 doesn't. I've googled the hardware and software support and don't find a result. Please help me to locate the question. Here is my system info:
`
# dmidecode 3.1
Getting SMBIOS data from sysfs.
SMBIOS 2.8 present.
130 structures occupying 4192 bytes.
Table at 0x000EA400.
...
Processor Information
	...
	Version: Intel(R) Xeon(R) CPU E5-2689 0 @ 2.60GHz
	Voltage: 0.0 V
...
Handle 0x003B, DMI type 16, 35 bytes
Physical Memory Array
	Location: System Board Or Motherboard
	Use: System Memory
	Error Correction Type: None
...
### 评论 #1 — ROCmSupport (2021-04-05T10:15:52Z)

Hi @Raumss 
Thanks for reaching out
MI50 is supported hardware which is Vega20 variant but with server capabilities.
I just tested with latest ROCm 4.1 and it works perfect. Request you to try with the same.
