...
> **Issue #1619**
> **状态**: closed
> **创建时间**: 2021-11-16T18:26:46Z
> **更新时间**: 2024-01-25T17:59:59Z
> **关闭时间**: 2024-01-25T17:59:58Z
> **作者**: bigtrak
> **标签**: 
...
### 评论 #1 — Mystro256 (2021-11-16T19:49:34Z)

Hi,

The current implementation will generate a local key and sign the kernel modules using the local key if signing is not setup already.

I understand that your site does not want to use signing, I guess I'm just missing how this results in a bug, as the kernel should ignore the signature if signing enforcement is not enabled. I've personally tested this on CentOS 7 and 8, so I'm a bit confused how to reproduce.

Thank you!

---

### 评论 #2 — ROCmSupport (2021-11-17T07:46:59Z)

Thanks @bigtrak for reaching out.
As we share signed rocm packages always, we did not see any errors so far.
Can you please explain how to call this is an actual issue and also help me to reproducing this problem.
Reproducing locally is the mandatory step that we need to do and so need your help if we are able to reproduce this issue locally, so that I can understand the issue better and can give a feasible solution.
Thank you.

---

### 评论 #3 — Mystro256 (2022-01-18T21:03:07Z)

Hello, please note that I will update the logic for 5.0 to set sign_tool only if secure boot is enabled **and** sign_tool isn't already set. I think this would be a sensible compromise to meet other customer requirements. Please let me know if you have any concerns.

Sorry for any confusion or problems!

---

### 评论 #4 — abhimeda (2024-01-02T15:39:02Z)

@bigtrak, have we resolved your issue? Can we please close it?  Thanks!

---

### 评论 #5 — nartmada (2024-01-25T17:59:58Z)

Closing the ticket as there is no response from @bigtrak.  Please re-open the ticket if the issue still exists.  Thanks.
