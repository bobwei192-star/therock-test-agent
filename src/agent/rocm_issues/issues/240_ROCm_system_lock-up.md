...
> **Issue #240**
> **状态**: closed
> **创建时间**: 2017-10-28T09:56:18Z
> **更新时间**: 2018-06-03T15:19:15Z
> **关闭时间**: 2018-06-03T15:19:15Z
> **作者**: preda
> **标签**: 
...
### 评论 #1 — fxkamd (2017-10-30T15:49:50Z)

The backtrace shows a problem with the graphics stack, not ROCm.

Failure to allocated a page table means you've run out of VRAM. That condition seems to get the VRAM manager into a bad state, which causes problems with other VRAM manager users later on.

That code is under active development. Chances are it will be fixed in the next major release.

If you're looking for a workaround in your application, look for memory leaks and try to use less VRAM in general.

---

### 评论 #2 — preda (2017-10-30T21:17:33Z)

No, I'm not looking for a workaround. I don't think it's a genuine "out of memory" because I don't allocate much, especially I don't allocate anything more than usual when this happens. I just do an invalid operation (writing to a CL_MEM_HOST_NO_ACCESS), and that apparently produces the situation. Of course, the fix on my side is easy (I just don't do that invalid write) -- but nevertheless this "out of VRAM" is not a valid outcome. But maybe as you say it will just fix itself in the future.
