# Kernel Oops with ROCm 5.0.2 on CentOS 7.9 kernel 3.10.0-1160.45.1.el7.x86_64

> **Issue #1701**
> **状态**: closed
> **创建时间**: 2022-03-09T07:04:10Z
> **更新时间**: 2022-04-05T10:34:59Z
> **关闭时间**: 2022-04-05T10:34:59Z
> **作者**: bertwesarg
> **标签**: 
> **URL**: https://github.com/ROCm/ROCm/issues/1701
...
```
I attach also the output of [`dmidecode`](https://github.com/RadeonOpenCompute/ROCm/files/8212412/dmidecode.txt) of this machine and a [bootlog](https://github.com/RadeonOpenCompute/ROCm/files/8212420/dmesg-1062.txt) from an identical node with CentOS 7.7 and kernel 3.10.0-1062.el7.x86_64 and ROCm 4.5.2

The machine was freshly installed from scratch and I followed the install instructions with this [amdgpu-install](https://repo.radeon.com/amdgpu-install/21.50.1/rhel/7.9/amdgpu-install-21.50.1.50001-1.el7.noarch.rpm) and installing with:

```console
$ amdgpu-install -y --usecase=hip,rocm
```
...
### 评论 #1 — ROCmSupport (2022-03-16T05:33:50Z)

Hi @bertwesarg 
Thanks for reaching out.
Can you please share the outputs of /opt/rocm/bin/rocminfo and /opt/rocm/opencl/bin/clinfo.
And also request to share the details of GPU, CPU etc.,.
Thank you.

---

### 评论 #2 — bertwesarg (2022-03-16T06:10:40Z)

Please note, that the node under subject does not boot. I'm able to provide you the requested information from an identical node which is still on CentOS 7.7 and ROCm 4.5.2:

- [rocminfo-4.5.2.txt](https://github.com/RadeonOpenCompute/ROCm/files/8259320/rocminfo-4.5.2.txt)
- [clinfo-4.5.2.txt](https://github.com/RadeonOpenCompute/ROCm/files/8259324/clinfo-4.5.2.txt)
- [cpuinfo.txt](https://github.com/RadeonOpenCompute/ROCm/files/8259326/cpuinfo.txt)
- [lspci for the display controllers](https://github.com/RadeonOpenCompute/ROCm/files/8259335/lspci.txt)



---

### 评论 #3 — alanina (2022-03-22T04:31:55Z)

The original issue should be handled in ROCm 5.0.2. Can you try to uninstall via amdgpu-uninstall and then try to install the 5.0.2 release? There was a quirk in the dkms version provided by RHEL7/CentOS7 that should be handled if you remove the amdgpu-dkms package before installing 5.0.2 (instead of just upgrading to 5.0.2)

---

### 评论 #4 — ROCmSupport (2022-03-24T06:16:06Z)

Hi @bertwesarg 
Actually I tried on a clean machine(all previous versions of ROCm and amdgpu drivers removed) and am able to install ROCm 5.0.2 on CentOS 7.9 successfully.
Can you please do a clean uninstallation of rocm and amdgpu components on that machine and install freshly.
Thank you.

---

### 评论 #5 — bertwesarg (2022-04-05T10:34:59Z)

5.1.0 boots on CentOS 7.9 for me now. Thanks. Closing.
