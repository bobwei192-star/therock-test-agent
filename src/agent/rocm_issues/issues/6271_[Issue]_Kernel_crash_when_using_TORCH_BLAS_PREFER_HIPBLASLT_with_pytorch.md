...
> **Issue #6271**
> **状态**: open
> **创建时间**: 2026-05-18T17:20:36Z
> **更新时间**: 2026-05-20T19:49:55Z
> **作者**: Lama-Thematique
> **标签**: status: triage
...
### 评论 #1 — harkgill-amd (2026-05-20T18:33:18Z)

Hey @Lama-Thematique, is this only crashing with `TORCH_BLAS_PREFER_HIPBLASLT=1` or do you see this as well with the rocblas backend? For reference, I gave this a try on my end and wasn't able to repro the crashing with either rocblas or hipblaslt. The latter was slower but still completed successfully. Could you also share the output of `grep cwsr /sys/class/kfd/kfd/topology/nodes/1/properties`, this'll help confirm that the kernel + ROCm configuration you have is working as intended.

---

### 评论 #2 — Lama-Thematique (2026-05-20T19:49:55Z)

Hello, when either `TORCH_BLAS_PREFER_HIPBLASLT=0` or is unset the code runs as expected and report 0.7 TFLOPS, however i'm not sure how to verify that this is using rocblas as default.
