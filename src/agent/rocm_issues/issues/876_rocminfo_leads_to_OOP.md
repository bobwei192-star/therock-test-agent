...
> **Issue #876**
> **状态**: closed
> **创建时间**: 2019-08-26T20:18:26Z
> **更新时间**: 2023-08-05T18:26:56Z
> **关闭时间**: 2023-08-05T18:26:56Z
> **作者**: greytear
> **标签**: 
...
### 评论 #1 — JMadgwick (2019-08-27T07:58:32Z)

[Your Motherboard (and CPU) are not supported for this GPU. The RX 560 requires PCIe atomics.](https://github.com/RadeonOpenCompute/ROCm#supported-cpus)
From your dmesg:
```
[    2.375695] kfd kfd: skipped device 1002:67ef, PCI rejects atomics
```
[Kernel 4.19 is not supported either.](https://github.com/RadeonOpenCompute/ROCm#supported-operating-systems---new-operating-systems-available) However changing this won't make any difference because of the lack of PCIe atomics.

Your motherboard is pretty old and doesn't supports PCIe 3.0 at all, let alone atomics. You might be able to get Vega GPUs to work (they don't need atomics) but it's probably a better idea to get a newer motherboard. Anything AMD Ryzen or everything from Intel that's newer than Haswell will work.
