# clinfo showing duplicate gfx1012 GPU platforms for rocm-opencl for rocm 4.5

> **Issue #1604**
> **状态**: closed
> **创建时间**: 2021-10-28T17:34:17Z
> **更新时间**: 2021-11-01T04:08:39Z
> **关闭时间**: 2021-11-01T04:07:10Z
> **作者**: kaerumy
> **标签**: 
> **URL**: https://github.com/ROCm/ROCm/issues/1604

## 描述

rocm-opencl (2.0.0.40500-56) on unsupported Ubuntu 21.10
...
Platform #4: AMD Accelerated Parallel Processing
 `-- Device #0: gfx1012:xnack-
Platform #5: Portable Computing Language
 `-- Device #0: pthread-AMD Ryzen 5 5600X 6-Core Processor
...
error: unknown target CPU 'generic'
  ...
  Double-precision Floating-point support         (cl_khr_fp64)
    ...
    Support is emulated in software               No
  Address bits                                    64, Little-Endian
  Global memory size                              31454322688 (29.29GiB)
  Error Correction support                        No
...
kaeru@spidey:/opt$ benchmark-launcher 
kaeru@spidey:/opt$ clinfo
Number of platforms                               6
  Platform Name                                   AMD Accelerated Parallel Processing
  Platform Vendor                                 Advanced Micro Devices, Inc.
  Platform Version                                OpenCL 2.2 AMD-APP (3361.0)
...
### 评论 #1 — kaerumy (2021-11-01T04:07:10Z)

Proper package to install is `rocm-opencl-runtime` and `clinfo` list devices will show correct listing of supported platforms and work fine with newer kernels for Ubuntu versions after 20.04 LTS.
