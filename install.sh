...
echo -e "  ${GREEN}4.${NC} langgraph dev        ${BLUE}(终端1)${NC}"
echo -e "  ${GREEN}5.${NC} pnpm dev             ${BLUE}(终端2, cd etc/agent-chat-ui)${NC}"
echo -e "  ${GREEN}6.${NC} Agent Chat UI: ${GREEN}http://localhost:8080${NC}"
echo -e "  ${GREEN}7.${NC} CLI: python -m src.agent.cli run \"提示词\""
echo -e "${YELLOW}└──────────────────────────────────────────────────────────────────────┘${NC}"
echo ""
