...
verify_overlay_install() {
    ...
    local required_paths=(
        ...
        ".opencode/agents/therock-loop.md"
        ".opencode/agents/therock-executor.md"
        ".opencode/agents/therock-reporter.md"
        ".opencode/agents/therock-debugger.md"
        ".opencode/agents/therock-repairer.md"
        ".opencode/skills/therock-testing/SKILL.md"
...
print_usage() {
    ...
    echo "  /therock-debug-round run_id=<run_id> round=<N>"
    echo "  /therock-repair-round run_id=<run_id> round=<N> apply=off"
