# [Issue]: RuntimeError: CUDA error: HIPBLAS_STATUS_INVALID_VALUE when calling hipblasLtMatmulAlgoGetHeuristic

- **Issue #:** 6082
- **State:** closed
- **Created:** 2026-03-30T12:08:26Z
- **Updated:** 2026-03-30T21:37:22Z
- **URL:** https://github.com/ROCm/ROCm/issues/6082

### Problem Description

Hi, I am trying to get Pytorch to utilise my AMD GPU. Here are my specs:
...
I [installed ROCm 7.2](https://rocm.docs.amd.com/projects/install-on-linux/en/latest/install/quick-start.html) and Pytorch 2.9.1 (cp313) from [repo.radeon.com](https://repo.radeon.com/rocm/manylinux/rocm-rel-7.2/) (as well as triton-3.5.1, torchaudio-2.9.1, and torchvision-0.25.0).

I used a small XOR program to test whether things are working:
...
Run above program using `python3 xor.py`
